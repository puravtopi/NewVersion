...
public class MacrosMasterService : ParentService
{
    ...
    public void Insert(tbl_macros_master data)
    {
		...
		(bodypart,heading,cc_desc,pe_desc,a_desc,p_desc,cf,pn,rom_desc,pre_select,cmp_id,created_date,created_by)Values
				(@bodypart,@heading,@cc_desc,@pe_desc,@a_desc,@p_desc,@cf,@pn,@rom_desc,@pre_select,@cmp_id,@created_date,@created_by)", conn);
